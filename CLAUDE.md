...
- **Tab 1: Competitive Overview** — Side-by-side comparison table, "Who's Winning & Why" narrative, ER bar chart with 3% target line, creator collab gauges + collab ER lift
...
- Current data: josecuervo.json, cazadores.json, hornitos.json, margaritatime.json (hashtags); duolingo.json, drinkpoppi.json (profiles)
