...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
tab_playbook, tab_convo, tab_profile, tab_audience = st.tabs([
...
with tab_profile:
    ...
    identifiers_p = get_available_identifiers(autostrat, report_type_p)
    ...
    if not identifiers_p:
        ...
        if not report_p:
            ...
            all_snapshots = get_section_across_reports(autostrat, report_type_p, "snapshot")
