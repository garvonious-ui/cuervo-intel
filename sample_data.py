...
BRAND_PROFILES = {
    ...
    "Lunazul": {
        # @lunazultequila — ~25K IG followers. Beam Suntory brand.
        # Affordable/value tier tequila. Product and sweepstakes-focused content.
        "ig_followers": 25_000,
        "tt_followers": 3_000,
    ...
    "Hornitos": {
        # @hornitostequila — ~80K IG followers. Sauza/Beam Suntory family.
        # "A Shot Worth Taking" positioning. Fun/dance-forward Reels content.
        "ig_followers": 80_000,
        "tt_followers": 18_000,
        "ig_posts_per_month": 52,
        "tt_posts_per_month": 48,
    ...
    "Cazadores": {
        # @tequilacazadores — ~38K IG followers. Bacardi brand.
        # "Real Tequila for Real People" tagline. Cocktail-focused, polished photography.
        "ig_followers": 38_000,
        "tt_followers": 5_000,
        "ig_posts_per_month": 48,
    ...
    "Milagro": {
        # @milagrotequila — ~30K IG followers. William Grant & Sons brand.
        # Modern/colorful branding. Product-forward with editorial photography.
        "ig_followers": 30_000,
        "tt_followers": 8_000,
        "ig_posts_per_month": 52,
    ...
    "El Jimador": {
        # @eljimadortequila — ~50K IG followers. Brown-Forman brand.
        # Mexico's #1 selling tequila. "Sip for Yourself" campaign.
        "ig_followers": 50_000,
        "tt_followers": 12_000,
        "ig_posts_per_month": 48,
    ...
    for brand in BRANDS:
        ...
        for platform in ["Instagram", "TikTok"]:
            ...
            for i in range(num_posts):
                ...
                actual_er = base_er * er_multiplier * random.uniform(0.7, 1.4)
