...
- Collaboration split: owned (cuervo only — organic brand posts) vs amplified (partner + influencer + collective — reach amplified by another account's audience) — see config.py split_owned_collab()
